...
const AddUser = ({ addDoctorHandler, setAdd, error, setError }) => {
                    ...
                    <DialogContent sx={{ height: 'auto' }}>
                        <Box sx={styles.select}>
                            ...
                            <Box sx={{ display: 'flex', gap: '1rem' }}>
                                ...
                                <FormControl fullWidth style={{ marginTop: '0.18rem' }}>
                                    <InputLabel id="demo-simple-select-label">Select Center</InputLabel>
                                    <Select
                                        labelId="demo-simple-select-label"
                                        id="demo-simple-select"
                            ...
                            <Box sx={{ display: 'flex', gap: '1rem', mt: '0.5rem' }}>
                                ...
                                <FormControl fullWidth style={{ marginBottom: '0.7rem' }}>
                                    ...
                                    <Select
                                        ...
                                        style={{ fontSize: '10px' }}
                                    >
                                        {showDesignation && designationlist && designationlist.designation.length != 0 ? (
