...
const UpdateUser = ({ updateDoctorHandler, setUpdate, error, setError, updateDoctor }) => {
                            ...
                            <Box sx={{ display: 'flex', gap: '1rem', marginTop: '-1rem', marginBottom: '0.5rem' }}>
                                <FormControl fullWidth style={{ marginBottom: '0.7rem' }}>
                                    ...
                                    >
                                        ...
                                        {showStateList && stateList && stateList.state.length != 0 ? (
                                            ...
                                            <MenuItem style={{ fontSize: '10px', height: '1.1rem' }}>
                                                Select Country first/Selected Country has no state
                                            </MenuItem>
                                        )}
                                    </Select>
                                </FormControl>
                                <FormControl fullWidth style={{ marginBottom: '0.7rem' }}>
                                    ...
                                    <Select
                                        ...
                                        style={{ fontSize: '10px' }}
                                    >
                                        {showCityList && cityList && cityList.city ? (
                                            ...
                                            <MenuItem style={{ fontSize: '10px', height: '1.1rem' }}>
                                                Select State first/Selected State has no City
                                            </MenuItem>
                                        )}
                                    </Select>
                                </FormControl>
                            ...
                            <Box sx={{ display: 'flex', gap: '1rem' }}>
                                <FormControl fullWidth style={{ marginBottom: '0.7rem' }}>
                                    ...
                                    <Select
                                        ...
                                        style={{ fontSize: '10px' }}
                                    >
                                        {showDepartment && departmentlist && departmentlist.department.length ? (
                                ...
                                <FormControl fullWidth style={{ marginBottom: '0.7rem' }}>
                                    ...
                                    <Select
                                        ...
                                        style={{ fontSize: '10px' }}
                                    >
                                        {designationlist && designationlist.designation.length != 0 ? (
