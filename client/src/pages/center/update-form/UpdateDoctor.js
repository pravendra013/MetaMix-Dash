...
const UpdateDoctor = ({ updateDoctorHandler, setUpdate, error, setError, updateDoctor }) => {
    ...
    const handleReset = () => {
        ...
        setCountry(updateDoctor.in_country_id);
                            ...
                            <Box sx={{ display: 'flex', gap: '1rem' }}>
                                <FormControl fullWidth style={{ marginBottom: '0.7rem' }}>
                                    ...
                                    <Select
                                        ...
                                        // value={updateDoctor.in_department_name}
                                        label="Age"
